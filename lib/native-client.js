...
class NativeClient {
   ...
   * Get the currentOp.
   *
   * @param {Integer} includeAll - if true also list currently idle operations in the result.
   * @param {Function} callback - The callback.
   */
  currentOp(includeAll, callback) { // TODO: deal with db versions? && do we want operations arg?
