...
class DataService extends EventEmitter {
  ...
  /**
   * Executes a usersInfo command on the currently connected instance.
   *
   * @param {object} options - Options passed to NativeClient.usersInfo method.
   * @param {Function} callback - The callback.
   */
  usersInfo(options, callback) {
    debug(`Running usersInfo command with options: ${options}`);
    this.client.usersInfo(options, callback);
  }
